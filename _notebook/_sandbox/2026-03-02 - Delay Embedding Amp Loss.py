...
@app.cell
def _(amplification_losses, fnn_losses, np):
    n_delays_list = []
    ...
    return amp_scores, delay_intervals_list, fnn_scores, n_delays_list


@app.cell
def _(amp_scores, delay_intervals_list, n_delays_list):
    n_delays_list[amp_scores.argmin()], delay_intervals_list[amp_scores.argmin()]
    return


@app.cell
def _(amp_scores, fnn_scores, np):
...
@app.cell
def _(amplification_losses, embed_signal_torch, fnn_losses, x):
    ...
    if len(fnn_losses) > 0:
        ...
        best_fnn_x_embedded = None
    return best_amp_x_embedded, best_amp_x_embedded_delay1, best_fnn_x_embedded
