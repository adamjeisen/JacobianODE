...
SWEEP_GROUP = "lorenz_partial_additive_mse_uniform_p30_obsnoise005__ndelays_sweep"
RUN_ID = "16s8uli1"
DEVICE = "cuda" if torch.cuda.is_available() else "cpu"

METRICS_PATH = (
    Path("/home/adameisen/Documents/jacobian-analyses")
    / "Lorenz_INDpartial_NDsweep_D1_NormTrue__JacobianODE"
    / SWEEP_GROUP
    / "metrics.json"
)
...
fig.suptitle(
    f"Run {RUN_ID} (p30 obsnoise005 ndelays sweep, n_delays=50, LC=0):\n"
