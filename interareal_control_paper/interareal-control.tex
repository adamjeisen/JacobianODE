...
% --- Author Block ---
\begin{center}
    \textbf{Authors:} % TODO: fill in the final author list when the paper is submitted.
    Adam J. Eisen, Andre M. Bastos, Jacob A. Donoghue, Meredith K. Mahnke, Scott L. Brincat, Emery N. Brown, Ila R. Fiete\textsuperscript{**}, and Earl K. Miller\textsuperscript{**}.
\end{center}

\vspace{1em}

% --- Attribution Section ---
\section*{Statement of contribution and publication}
\noindent \textit{% TODO: replace with the publication venue and contribution
% statement when the paper is submitted/accepted. Placeholder follows.
The work presented in this chapter is in preparation for submission.\\
\textsuperscript{**}I.R.F and E.K.M. contributed equally to this work.}

\vspace{1em}

\noindent % TODO: add the CRediT contribution statement here.
