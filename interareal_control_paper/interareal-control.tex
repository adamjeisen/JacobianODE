...
% --- Author Block (affiliations sourced from Eisen et al. 2024, Neuron) ---
\begin{center}
{\large
Adam J. Eisen\textsuperscript{1,2,3,4},
Andre M. Bastos\textsuperscript{5,6},
Jacob A. Donoghue\textsuperscript{3,7},
Meredith K. Mahnke\textsuperscript{1},
Scott L. Brincat\textsuperscript{1,3},
Emery N. Brown\textsuperscript{1,3,8,9},
Ila R. Fiete\textsuperscript{2,3,4,**},
...
\textsuperscript{4}The K. Lisa Yang Integrative Computational Neuroscience Center, Massachusetts Institute of Technology, Cambridge, MA 02139, USA\\
\textsuperscript{5}Department of Psychology, Vanderbilt University, Nashville, TN 37235, USA\\
\textsuperscript{6}Vanderbilt Brain Institute, Vanderbilt University, Nashville, TN 37235, USA\\
\textsuperscript{7}Beacon Biosignals, Boston, MA 02114, USA\\
\textsuperscript{8}Department of Anesthesia, Critical Care and Pain Medicine, Massachusetts General Hospital, Boston, MA 02114, USA\\
\textsuperscript{9}Division of Sleep Medicine, Harvard Medical School, Boston, MA 02115, USA
}
\end{center}
